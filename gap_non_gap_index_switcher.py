...
binding_site_HRH1_AC1 = [107, 108, 111, 112, 158, 428, 431, 432, 458]
binding_site_ACM1_AC1 = [105, 106, 109, 157, 189, 192, 193, 196, 197, 378, 381,
        382, 404, 407, 408, ]    

binding_site_HRH1 = [107, 108, 111, 112, 115, 158, 178, 179, 191, 198, 428,
        431, 432, 435, 450, 458]

binding_site_HRH1_AC1_fatcat = [107, 108, 111, 112, 158, 398, 401, 402, 428]

# ACM1 fatcat seq dict:  ['ACM1_HUMAN', [[79, 105, 'D'], [80, 106, 'Y'], [83,
# 109, 'S'], [131, 157, 'W'], [163, 189, 'T'], [166, 192, 'T'], [167, 193,
# 'A'], [170, 196, 'A'], [171, 197, 'F'], [353, 378, 'Y'], [356, 381, 'L'],
# [357, 382, 'V'], [379, 404, 'P'], [382, 407, 'I'], [383, 408, 'M']]]
binding_site_ACM1_AC1_fatcat = [105, 106, 109, 157, 189, 192, 193, 196, 197,
        402, 405, 406, 428, 431, 432]

residue_index_dict = {
        'HRH1': binding_site_HRH1_AC1,
        'ACM1': binding_site_ACM1_AC1,}

fatcat_index_dict = {
        'HRH1': binding_site_HRH1_AC1_fatcat,
        'ACM1': binding_site_ACM1_AC1_fatcat,
        }
#residue_index_dict = {
#        'HRH1': tm_region_HRH1,
#        'ACM1': tm_region_ACM1,}
...
print 'HRH1 (3rze) Binding site\n'

gross_seq_index_dict = extract_pos(True, records, residue_index_dict,
        start_pos=1)

fatcat_seq_index_dict = extract_pos(True, records_fatcat, fatcat_index_dict,
        start_pos=28)
...
for i, pair in enumerate(pairs_gross_HRH1):
    if pairs_gross_HRH1[i] == pairs_fatcat_HRH1[i]:
        #print 'Match found!'
        #print pairs_gross_HRH1[i], pairs_fatcat_HRH1[i]
        num_matches += 1

print 'HRH1 pair similarity ratio: ', num_matches/len(pairs_gross_HRH1), '\n'

# ACM1 #
########
print 'ACM1 (5cvx) Binding site \n'
...
for i, pair in enumerate(pairs_gross_ACM1):
    if pairs_gross_ACM1[i] == pairs_fatcat_ACM1[i]:
        #print 'Match found!'
...
print 'ACM1 pair similarity ratio: ', num_matches/len(pairs_gross_ACM1), '\n'
